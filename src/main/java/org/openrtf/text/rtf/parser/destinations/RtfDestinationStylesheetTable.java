...
import org.openrtf.text.rtf.style.RtfStyleTypes;

/**
 * <code>RtfDestinationStylesheetTable</code> handles data destined for the Stylesheet Table
 * destination
 *
...
public class RtfDestinationStylesheetTable extends RtfDestination {
    ...
    /**
     * <code>RtfParagraphStyle</code> object for setting styleshee values as they are parsed from
     * the input.
     */
    ...
    public void createNewStyle() {
        // public RtfParagraphStyle(String styleName, String fontName, int fontSize, int fontStyle,
        // Color fontColor)
