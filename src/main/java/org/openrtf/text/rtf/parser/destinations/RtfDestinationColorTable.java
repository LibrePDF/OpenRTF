...
import org.openrtf.text.rtf.parser.enumerations.RtfColorThemes;
...
public class RtfDestinationColorTable extends RtfDestination {
     ...
     */
    /**
     * Specifies the tint when specifying a theme color. RTF control word ctint
     *
     * <p>0 - 255: 0 = full tint(white), 255 = no tint. Default value: 255
     *
     * <p>If tint is specified and is less than 255, cshade must equal 255. ctint/cshade are
     * mutually exclusive
     *
     * @see org.openrtf.text.rtf.parser.destinations.RtfDestinationColorTable#cshade
     * @see org.openrtf.text.rtf.parser.destinations.RtfDestinationColorTable#themeColor
     */
    private int ctint = 255;

    /**
     * Specifies the shade when specifying a theme color. RTF control word cshade
     *
     * <p>0 - 255: 0 = full shade(black), 255 = no shade. Default value: 255
     *
     * <p>If shade is specified and is less than 255, ctint must equal 255. cshade/ctint are
     * mutually exclusive
     *
     * @see org.openrtf.text.rtf.parser.destinations.RtfDestinationColorTable#ctint
     * @see org.openrtf.text.rtf.parser.destinations.RtfDestinationColorTable#themeColor
     */
     ...
     *
     * @see org.openrtf.text.rtf.parser.enumerations.RtfColorThemes
     * @see org.openrtf.text.rtf.parser.destinations.RtfDestinationColorTable#ctint
     * @see org.openrtf.text.rtf.parser.destinations.RtfDestinationColorTable#cshade
     */
    ...
    public boolean handleControlWord(RtfCtrlWordData ctrlWordData) {
        ...
        // if(ctrlWordData.ctrlWord.equals("cmaindarkone"))
        // this.setThemeColor(ctrlWordData.ctrlWord);
        // if(ctrlWordData.ctrlWord.equals("cmainlightone"))
        // this.setThemeColor(ctrlWordData.ctrlWord);
        // if(ctrlWordData.ctrlWord.equals("cmaindarktwo"))
        // this.setThemeColor(ctrlWordData.ctrlWord);
        // if(ctrlWordData.ctrlWord.equals("cmainlighttwo"))
        // this.setThemeColor(ctrlWordData.ctrlWord);
        ...
        // if(ctrlWordData.ctrlWord.equals("caccentthree"))
        // this.setThemeColor(ctrlWordData.ctrlWord);
        // if(ctrlWordData.ctrlWord.equals("caccentfour"))
        // this.setThemeColor(ctrlWordData.ctrlWord);
        // if(ctrlWordData.ctrlWord.equals("caccentfive"))
        // this.setThemeColor(ctrlWordData.ctrlWord);
        ...
        // if(ctrlWordData.ctrlWord.equals("cfollowedhyperlink"))
        // this.setThemeColor(ctrlWordData.ctrlWord);
        // if(ctrlWordData.ctrlWord.equals("cbackgroundone"))
        // this.setThemeColor(ctrlWordData.ctrlWord);
        // if(ctrlWordData.ctrlWord.equals("ctextone")) this.setThemeColor(ctrlWordData.ctrlWord);
        // if(ctrlWordData.ctrlWord.equals("cbacgroundtwo"))
        // this.setThemeColor(ctrlWordData.ctrlWord);
    ...
    /**
     * Processes the color triplet parsed from the document. Add it to the import mapping so colors
     * can be mapped when encountered in the RTF import or conversion.
     */
    private void processColor() {
        if (red != -1 && green != -1 && blue != -1) {
            if (this.rtfParser.isImport()) {
                this.importHeader.importColor(
                        Integer.toString(this.colorNr), new Color(this.red, this.green, this.blue));
            }
     ...
     *
     * @param key The map number. *@return <code>Color</code> object from the map. null if key does
     *     not exist.
     */
