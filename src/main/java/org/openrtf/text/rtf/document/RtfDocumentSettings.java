...
import org.openrtf.text.rtf.document.output.RtfDataCache;
import org.openrtf.text.rtf.style.RtfParagraphStyle;

/**
 * The RtfDocumentSettings contains output specific settings. These settings modify how the actual
 * document is then generated and some settings may mean that some RTF readers can't read the
 * document or render it wrongly.
 *
...
public class RtfDocumentSettings {
    ...
    /**
     * Whether to write image scaling information. This is required for Word 2000, 97 and Word for
     * Mac
     */
    ...
    /**
     * Images are written as binary data and not hex encoded. Author: Mark Hall
     * (Mark.Hall@mail.room3b.eu)
     *
     * @since 2.1.1
     */
    ...
    /**
     * Sets whether to output the line breaks for increased rtf document readability. Some line
     * breaks may be added where the rtf specification demands it.
     *
    ...
    /**
     * Sets whether the table row definition should also be written after the cell content. This is
     * recommended to be set to <code>true</code> if you need Word2000 compatiblity and <code>false
     * </code> if the document should be opened in OpenOffice.org Writer.
     *
     ...
     *
     * @return <code>True</code> if soft linebreaks are generated, <code>false</code> for hard
     *     linebreaks.
     */
     ...
     *
     * @param alwaysUseUnicode <code>True</code> to use unicode representation, <code>false</code>
     *     otherwise.
     */
    ...
    /**
     * Sets the data cache style. This controls where the document is cached during generation. Two
     * cache styles are supported:
     *
     * <ul>
     *   <li>RtfDataCache.CACHE_MEMORY: The document is cached in memory. This is fast, but places a
     *       limit on how big the document can get before causing OutOfMemoryExceptions.
     *   <li>RtfDataCache.CACHE_DISK: The document is cached on disk. This is slower than the
     *       CACHE_MEMORY setting, but the document size is now only constrained by the amount of
     *       free disk space.
     * </ul>
     *
     * @param dataCacheStyle The data cache style to set. Valid constants can be found in
     *     RtfDataCache.
     * @see org.openrtf.text.rtf.document.output.RtfDataCache
     */
    ...
    /**
     * Sets the image PDF conformance setting. By default images will be added as if they were
     * displayed with 72dpi. Set this to <code>false</code> if images should be generated with the
     * Word default DPI setting.
     *
     * @param imagePDFConformance <code>True</code> if PDF equivalence is desired, <code>false
     *     </code> for the default Word display.
     */
    ...
    /**
     * Sets whether image scaling information should be written. This needs to be set to <code>true
     * </code> MS Word 2000, MS Word 97 and Word for Mac.
     *
    ...
    /**
     * Set the options required for RTF documents to display correctly in MS Word 2000 and MS Word
     * 97. Sets <code>outputTableRowDefinitionAfter = true</code> and <code>
     * writeImageScalingInformation = true</code>.
     */
    ...
    /**
     * Set the options required for RTF documents to display correctly in MS Word for Mac. Sets
     * <code>
     * writeImageScalingInformation = true</code>.
     */
    ...
    /**
     * Set the options required for RTF documents to display correctly in MS Word XP (2002). Sets
     * <code>writeImageScalingInformation = false</code>.
     */
    ...
    /**
     * This function is not intended for general use. Please see 'public boolean setProtection(int
     * level, String pwd)'. Author: Howard Shank (hgshank@yahoo.com)
     *
    ...
    /**
     * Converts protection level from internal bitmap value to protlevel output value. Author:
    ...
    /**
     * Set the RTF flag that recommends the document be opened in read only mode. Author: Howard
     * Shank (hgshank@yahoo.com)
     *
    ...
    /**
     * Set whether images are written as binary data or are hex encoded. Author: Mark Hall
     * (Mark.Hall@mail.room3b.eu)
     *
     * @param imageWrittenAsBinary <code>True</code> to write images as binary data, <code>false
    ...
    /**
     * Gets whether images are written as binary data or are hex encoded. Defaults to <code>true
     * </code>. Author: Mark Hall (Mark.Hall@mail.room3b.eu)
     *
     * @since 2.1.1
     * @return <code>True</code> if images are written as binary data, <code>false</code> if hex
     *     encoded.
     */
