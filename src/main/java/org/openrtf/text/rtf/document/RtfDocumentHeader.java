...
import org.openrtf.text.rtf.document.output.RtfNilOutputStream;
import org.openrtf.text.rtf.headerfooter.RtfHeaderFooter;
import org.openrtf.text.rtf.headerfooter.RtfHeaderFooterGroup;
import org.openrtf.text.rtf.list.RtfList;
import org.openrtf.text.rtf.list.RtfListTable;
import org.openrtf.text.rtf.style.RtfColor;
import org.openrtf.text.rtf.style.RtfColorList;
...
import org.openrtf.text.rtf.style.RtfStylesheetList;
...
public class RtfDocumentHeader extends RtfElement {
    ...
    /**
     * The protection settings Author: Howard Shank (hgshank@yahoo.com)
     *
     * @since 2.1.1
     */
    ...
    /**
     * Converts a HeaderFooter into a RtfHeaderFooterGroup. Depending on which class the
     * HeaderFooter is, the correct RtfHeaderFooterGroup is created.
     *
     ...
     * @see org.openrtf.text.rtf.headerfooter.RtfHeaderFooter
     * @see org.openrtf.text.rtf.headerfooter.RtfHeaderFooterGroup
     */
