...
/**
 * The RtfAddableElement is the superclass for all rtf specific elements that need to be added to an
 * iText document. It is an extension of Chunk and it also implements RtfBasicElement. It is an
 * abstract class thus it cannot be instantiated itself and has to be subclassed to be used.
 *
...
public abstract class RtfAddableElement extends Chunk implements RtfBasicElement {
    ...
    /**
     * Constructs a new RtfAddableElement. The Chunk content is set to an empty string and the font
     * to the default Font().
     */
