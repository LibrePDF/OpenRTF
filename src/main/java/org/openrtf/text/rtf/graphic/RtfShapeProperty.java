package org.openrtf.text.rtf.graphic;
...
/**
 * The RtfShapeProperty stores all shape properties that are not handled by the RtfShape and
 * RtfShapePosition.<br>
 * <br>
 * There is a huge selection of properties that can be set. For the most important properites there
 * are constants for the property name, for all others you must find the correct property name in
 * the RTF specification (version 1.6).<br>
 * <br>
...
public class RtfShapeProperty extends RtfAddableElement {
    ...
    /**
     * Property for defining the minimum horizontal coordinate that is visible. Requires a long
     * value.
     */
    public static final String PROPERTY_GEO_LEFT = "geoLeft";

    /**
     * Property for defining the maximum horizontal coordinate that is visible. Requires a long
     * value.
     */
    ...
    /**
     * Property for defining the first adjust handle for shapes. Used with the rounded rectangle.
